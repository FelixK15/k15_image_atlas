...
typedef enum _K15_AtlasResults
{
	...
	K15_IA_RESULT_ATLAS_TOO_LARGE = 6		//<! The atlas has grown too large (Specfied by K15_IA_DIMENSION_THRESHOLD)
} kia_result;
...
//											   p_PixelDataWith and/or p_PixelDataHeight are invalid)
